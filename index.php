...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">Load Time<br>(First View vs Repeat) <div class="pull-right"><span class="avg-fv"><?php echo round(array_sum($avg_load_times_fv)/count($avg_load_times_fv), 2) . "s"; ?></span><span class="avg-rv">(<?php echo round(array_sum($avg_load_times_rv)/count($avg_load_times_rv), 2) . "s"; ?>)</span></div></div>
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">Render Time<br>(First View vs Repeat) <div class="pull-right"><span class="avg-fv"><?php echo round(array_sum($avg_render_times_fv)/count($avg_render_times_fv), 2) . "s"; ?></span><span class="avg-rv">(<?php echo round(array_sum($avg_render_times_rv)/count($avg_render_times_rv), 2) . "s"; ?>)</span></div></div>
			<div class="panel-body ">
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">Time to Fully Loaded<br>(First View vs Repeat) <div class="pull-right"><span class="avg-fv"><?php echo round(array_sum($avg_fullyLoaded_times_fv)/count($avg_fullyLoaded_times_fv), 2) . "s"; ?></span><span class="avg-rv">(<?php echo round(array_sum($avg_fullyLoaded_times_rv)/count($avg_fullyLoaded_times_rv), 2) . "s"; ?>)</span></div></div>
			<div class="panel-body ">
...
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">Connections<br>(First View vs Repeat) <div class="pull-right"><span class="avg-fv"><?php echo round(array_sum($avg_connections_fv)/count($avg_connections_fv), 2); ?></span><span class="avg-rv">(<?php echo round(array_sum($avg_connections_rv)/count($avg_connections_rv), 2); ?>)</span></div></div>
			<div class="panel-body ">
	...
	<div class="col-md-4">
		<div class="panel panel-default">
			<div class="panel-heading">Requests<br>(First View vs Repeat) <div class="pull-right"><span class="avg-fv"><?php echo round(array_sum($avg_requests_fv)/count($avg_requests_fv), 2); ?></span><span class="avg-rv">(<?php echo round(array_sum($avg_requests_rv)/count($avg_requests_rv), 2); ?>)</span></div></div>
			<div class="panel-body ">
	...
	<div class="col-md-4">
		<div class="panel <?php echo $panel_class; ?> ">
			<div class="panel-heading">Responses_404<br>(First View vs Repeat) <div class="pull-right"><span class="avg-fv"><?php echo round(array_sum($avg_404_fv)/count($avg_404_fv), 2); ?></span><span class="avg-rv">(<?php echo round(array_sum($avg_404_rv)/count($avg_404_rv), 2); ?>)</span></div></div>
			<div class="panel-body ">
